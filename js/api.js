...
// 🎯 นี่คือ URL เดียวที่ถูกต้อง (deployment ล่าสุด) — export ออกไปให้ไฟล์อื่น import ใช้ต่อ
// แทนที่จะ hardcode URL ซ้ำคนละจุด (สาเหตุของบั๊ก "ส่งไฟล์ไม่ได้" ก่อนหน้านี้)
export const PORTFOLIO_API = "https://script.google.com/macros/s/AKfycbyt-WlFCvqGvlmAKXfIbqS-Eodd1oi3CJN8fNSYbQmWTJ5O3WllWgMN87Z6rRQxGAaIcg/exec";
